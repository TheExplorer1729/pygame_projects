...
class Editor():
    def __init__(self):
        ...
        pygame.display.set_caption('Editor_name')
    ...
    def run(self):
        while True:
            ...
            if self.clicking and self.ongrid:
                ...
                self.tilemap.tilemap[tile_loc] = {'type':self.tile_list[self.tile_group], 'variant': self.tile_variant, 'pos':tile_pos}
            ...
            for event in pygame.event.get():
                ...
                if event.type == pygame.KEYDOWN:
                    ...
                    if event.key == pygame.K_m:
                        self.tilemap.save('ninja_game/map.json')
